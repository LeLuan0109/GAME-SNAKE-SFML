...
Engine::Engine() {
   ...
   /* checkLevelFiles();*/
    ...
    mainFont.loadFromFile("class/font/slant_regular.ttf");
    setupText(&titleText, mainFont, "SNAKE",size , Color::Blue);
    ...
    setupText(&scoreText, mainFont, to_string(score), size , Color::White);
